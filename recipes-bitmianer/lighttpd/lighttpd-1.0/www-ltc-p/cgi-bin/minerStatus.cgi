...
if [ "${ant_stats_tmp}" != "Socket connect failed: Connection refused" ]; then
	...
	do
		...
		if [ -n ${ant_chain_acn} -a ${ant_chain_acn} != "0" ]; then		
			...
			ant_temp3=${ant_stats_tmp#*temp31=}
            ant_temp3=${ant_temp3%%,temp32=*}  
            		
			ant_temp4=${ant_stats_tmp#*temp4_1=}
            ant_temp4=${ant_temp4%%,temp4_2=*}  
...
###############################################################################################	
			...
			echo "<td class=\"cbi-value-field\">"                                                                                                   
            		...
            		echo "</td>"  
			echo "<td class=\"cbi-value-field\">"
			echo "<div id=\"cbi-table-1-temp\">I:${ant_temp3} O:${ant_temp}</div>"
			echo "<div id=\"cbip-table-1-temp\"></div>"
			echo "</td>"
            		echo "<td class=\"cbi-value-field\">"
            		echo "<div id=\"cbi-table-1-temp2\">I:${ant_temp4} O:${ant_temp2}</div>"
		...
		if [ -n ${ant_chain_acn} -a ${ant_chain_acn} != "0" ]; then		
            ...
            ant_temp3=${ant_stats_tmp#*temp32=}
            ant_temp3=${ant_temp3%%,temp33=*}  
            		
			ant_temp4=${ant_stats_tmp#*temp4_2=}
            ant_temp4=${ant_temp4%%,temp4_3=*}
...
###############################################################################################
		...
		if [ -n ${ant_chain_acn} -a ${ant_chain_acn} != "0" ]; then		
            ...
            ant_temp3=${ant_stats_tmp#*temp33=}
            ant_temp3=${ant_temp3%%,temp34=*}  
            		
			ant_temp4=${ant_stats_tmp#*temp4_3=}
            ant_temp4=${ant_temp4%%,temp4_4=*}
...
###############################################################################################
		...
		if [ -n ${ant_chain_acn} -a ${ant_chain_acn} != "0" ]; then
			...
			ant_temp2=${ant_temp2%%,temp31=*}
            
            ant_temp3=${ant_stats_tmp#*temp34=}
            ant_temp3=${ant_temp3%%,temp4_1=*}  
            		
			ant_temp4=${ant_stats_tmp#*temp4_4=}
            ant_temp4=${ant_temp4%%,temp_max=*}
